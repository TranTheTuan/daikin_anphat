            ...
            <div class="container">
                <div class="row">
                    <div class="col footer-brand">
                        <img class="" src="<?php echo get_template_directory_uri() . '/assets/images/anphat_footer_logo.jpg' ?>" alt="Logo Anphat">
                        <span class="footer-company-name mx-5">công ty tnhh thiết bị phụ tùng an phát</span>
                    </div>
                </div>
                <div class="row my-5">
                    <div class="col-3">
                ...
                <div class="row">
                    <div class="col=4 legal-info">
                        <a href="http://www.online.gov.vn/Home/WebDetails/24959"><img style="height:63px;" src="<?php echo get_template_directory_uri() . '/assets/images/logoSaleNoti.png' ?>" alt=""></a>
                        <a href="https://www.dmca.com/Protection/Status.aspx?ID=03854138-0341-4475-a652-319dcd198bb4&refurl=https://thietbicongnghiep.net/"><img style="height:38px;" src="<?php echo get_template_directory_uri() . '/assets/images/DMCA_logo-grn-btn150w.png' ?>" alt=""></a>
    ...
    <div class="copyright">
        ...
        Copyrights © <?php echo date("Y"); ?> Công ty TNHH Thiết bị Phụ tùng An Phát. GPĐKKD số: 0100950365 do Sở KHĐT TP.Hà Nội cấp ngày 20/10/1999
        </div>
    </div>
    </div>
</body>
